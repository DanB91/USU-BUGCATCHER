/*
 * BUG 2 : LINE 28 missing *12 to get feet in terms of inches
 */
...
public BMI_bug2( int ft, int in, int lbs)
{
    feet= ft;
    inches = in;
    weight = lbs;
...
public String bmiRating( )
{
  ...
  /*  public static void main(String[] args) {
        ...
        BMI_bug2 bmi = new BMI_bug2(arg1, arg2, arg3);
