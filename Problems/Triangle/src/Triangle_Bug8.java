//Does not check to see that the inputs are overflowed
public class Triangle_Bug8 {
    ...
    /*constructor*/
    public Triangle_Bug8(double angle1, double angle2, double angle3){
        firstAngle = angle1;
        secondAngle = angle2;
        thirdAngle = angle3;
    }
    ...
    public static void main(String[] args) {        
       ...
       if((Math.floor(arg1)==arg1 && Math.floor(arg2)==arg2 && Math.floor(arg3)==arg3)){
        ...
        Triangle_Bug8 tr = new Triangle_Bug8(arg1, arg2, arg3);
