//Does not check to see if inputs are integers



public class Triangle_Bug7 {
    ...
    /*constructor*/
    public Triangle_Bug7(double angle1, double angle2, double angle3){
        firstAngle = angle1;
        secondAngle = angle2;
        thirdAngle = angle3;
    }
    ...
    public static void main(String[] args) {        
       try{ 
        ...
        Triangle_Bug7 tr = new Triangle_Bug7(arg1, arg2, arg3);
