//Error: does not check to see if inputs are numbers; no try,catch



public class Triangle_Bug6 {
    ...
    /*constructor*/
    public Triangle_Bug6(double angle1, double angle2, double angle3){
        firstAngle = angle1;
        secondAngle = angle2;
        thirdAngle = angle3;
    }
    ...
    public static void main(String[] args) {        
       ...
       if((Math.floor(arg1)==arg1 && Math.floor(arg2)==arg2 && Math.floor(arg3)==arg3)){//check that all inputs are integers
        if(arg1 <=2000000000 && arg2<=2000000000 && arg3 <= 2000000000){//check that double is not overflowed
        		
        
        Triangle_Bug6 tr = new Triangle_Bug6(arg1, arg2, arg3);
