...
function refreshProbList() //from Admin.js
{
      ...
      for(var i = 0; i < availableProbs.length; i++)
      {
 			 	...
 			 	xmlGetDifficulty.onreadystatechange=function()
  				{
    				...
    				{
						//content += "<option onDblClick='addProb(this.value)' class='difficulty"+xmlGetDifficulty.responseText+"'>" + availableProbs[i] + "</option>";   
						alert(xmlGetDifficulty.responseText);
    				}
  				}
