...
getFileNameXML.open("GET","AdminCompContent/getFileName.php",true);
getFileNameXML.send();
...
//###############################################################################################################
		...
		registerStudentsXML.open("GET","AdminCompContent/bulkRegistration.php?firstNames[]="+studentFirstNames+"&lastNames[]="+studentLastNames+"&usernames[]="+studentUsernames+"&passwords[]="+studentPasswords+"&schoolNames[]="+studentSchoolNames+"&states[]="+studentStates+"&teamNames[]="+teamNames+"&studentIndexes[]="+studentIndexes,true);
